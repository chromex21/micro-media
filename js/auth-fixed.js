...
(function() {
    ...
    function addChangePasswordUI() {
        ...
        // Check if Account tab already exists in HTML
        if (accountTabContent) {
            console.log('✓ Account tab already exists in HTML');
            return;
        }
        
        // Check if we already added the Account tab button
        if (document.getElementById('account-tab-btn')) {
            console.log('✓ Account tab button already exists');
            return;
        }
        ...
        // Create Account tab content (NEW ID to prevent conflicts)
        const accountTabContentNew = document.createElement('div');
        accountTabContentNew.id = 'account-tab-content'; // Different ID
        accountTabContentNew.className = 'tab-content';
        accountTabContentNew.innerHTML = `
            <div class="section">
                <h2>👤 Manage Account Preferences</h2>
                <p style="color: var(--text-secondary); margin-bottom: var(--spacing-lg);">
                    Change your admin credentials. Make sure to remember your new password!
                </p>
            ...
            <div class="section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="site-name" value="Lite Media" placeholder="Your site name">
                </div>
                <div class="form-group">
                    <label>Site Description</label>
                    <textarea id="site-desc" rows="3" placeholder="Describe your site..."></textarea>
                </div>
                <button class="btn" onclick="window.adminGallery.saveAccountSettings()">💾 Save Settings</button>
            </div>
            ...
            <div class="section">
                ...
                <button class="btn btn-danger" onclick="window.adminGallery.clearAllData()">⚠️ Clear All Data</button>
            </div>
        `;
